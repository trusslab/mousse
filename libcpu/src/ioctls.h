 ...
 */
  ...
  IOCTL(MEDIA_IOC_DEVICE_INFO, IOC_R, MK_PTR(MK_STRUCT(STRUCT_media_device_info)))
  IOCTL(MEDIA_IOC_ENUM_ENTITIES, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_media_entity_desc)))
  IOCTL(BINDER_VERSION, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_binder_version)))
  IOCTL(BINDER_SET_MAX_THREADS, IOC_W, MK_PTR(TYPE_ULONG)) /* size_t */
//FIXME
  IOCTL(BINDER_WRITE_READ, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_binder_write_read))) 
  IOCTL(VIDIOC_SUBSCRIBE_EVENT, IOC_W, MK_PTR(MK_STRUCT(STRUCT_v4l2_event_subscription)))
  IOCTL(VIDIOC_UNSUBSCRIBE_EVENT, IOC_W, MK_PTR(MK_STRUCT(STRUCT_v4l2_event_subscription)))
  IOCTL(VIDIOC_QUERYCAP, IOC_R, MK_PTR(MK_STRUCT(STRUCT_v4l2_capability)))
  IOCTL(VIDIOC_DQEVENT, IOC_R, MK_PTR(MK_STRUCT(STRUCT_v4l2_event)))
  IOCTL(ION_IOC_ALLOC, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_ion_allocation_data)))
  IOCTL(ION_IOC_SHARE, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_ion_fd_data)))
  IOCTL(ION_IOC_FREE, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_ion_handle_data)))
//FIXME start
  //UNKNOWN_CMD means we can't know the data structure of the CMD arguments. We only know the size of the structure, so make a fake ARRAY with the corresponding size
  IOCTL(UNKNOWN_CMD1, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0xb4)))
  IOCTL(UNKNOWN_CMD2, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x04)))
  IOCTL(UNKNOWN_CMD3, IOC_R, TYPE_NULL)
  IOCTL(UNKNOWN_CMD4, IOC_R, TYPE_NULL)
  IOCTL(UNKNOWN_CMD5, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x04)))
  IOCTL(UNKNOWN_CMD6, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x04)))
  IOCTL(UNKNOWN_CMD7, IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x0c)))
  IOCTL(UNKNOWN_CMD8, IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x40)))
  IOCTL(UNKNOWN_CMD9, IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x40)))
  IOCTL(UNKNOWN_CMD10, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x90)))
  IOCTL(UNKNOWN_CMD11, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x08)))
  IOCTL(UNKNOWN_CMD12, IOC_R | IOC_W, MK_PTR(MK_ARRAY(TYPE_CHAR, 0x08)))
  //IOCTL(SNDRV_CTL_IOCTL_ELEM_READ, IOC_R | IOC_W, MK_PTR(MK_STRUCT(STRUCT_snd_ctl_elem_id)))
  IOCTL(SNDRV_CTL_IOCTL_ELEM_READ, IOC_R | IOC_W, MK_PTR(TYPE_INT))
  IOCTL(SNDRV_CTL_IOCTL_ELEM_WRITE, IOC_R | IOC_W, MK_PTR(TYPE_INT))
  IOCTL(SNDRV_CTL_IOCTL_ELEM_INFO, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(SNDRV_CTL_IOCTL_ELEM_LIST, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(SNDRV_CTL_IOCTL_TLV_READ, IOC_R | IOC_W, MK_PTR(TYPE_INT))
  IOCTL(SNDRV_CTL_IOCTL_CARD_INFO, IOC_R | IOC_W, MK_PTR(TYPE_INT))
