...
#define kvm_insert_breakpoint(...) 1
#define kvm_remove_breakpoint(...) 1
#define kvm_remove_all_breakpoints(...)
...
//        case IDX_FLAGS_REG: GET_REG32(env->eflags);
        case IDX_FLAGS_REG: GET_REG32(env->mflags);
...
#elif TARGET_ARM
		fprintf(stderr, "FIXME for get_feature_xml\n");
#else
...
{
//	fprintf(stderr, "gdb_register_coprocessor not implemented\n");
}
#endif
