...
void tb_invalidate_phys_page(tb_page_addr_t addr, uintptr_t pc, void *puc);
void user_tb_invalidate_phys_range(target_ulong start, target_ulong end, int is_cpu_write_access);
#endif
