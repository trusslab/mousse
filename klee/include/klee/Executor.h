...
protected:
    ...
    PTree *processTree;
    bool concolicMode;
    bool mousseConcretizeWOConstraints;
    ...
    void updateGlobalEnv(ExecutionState &state, void *env);
    ...
    virtual void notifyForkBeforeBranch(ExecutionState &originalState, ref<Expr> &condition, Executor::StatePair &targets, int type, bool &swap);
    ...
    virtual StatePair fork(ExecutionState &current, ref<Expr> condition, bool isInternal, bool deterministic = false,
                           bool keepConditionTrueInCurrentState = false, bool isSyscallConcretize = false);
...
public:
    ...
    uint64_t toMultiConstant(ExecutionState &state, ref<Expr> e, const char *purpose);
    ...
    MemoryObject *addRamExternalObject(ExecutionState &state, void *addr, unsigned size, bool isReadOnly,
                                    bool isUserSpecified = false, bool isSharedConcrete = false,
                                    bool isValueIgnored = false);
    MemoryObject *addSymRegsExternalObject(ExecutionState &state, void *addr, unsigned size, bool isReadOnly,
                                    bool isUserSpecified = false, bool isSharedConcrete = false,
                                    bool isValueIgnored = false);
