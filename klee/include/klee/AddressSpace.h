...
//FIXME: this should only be changed in distributed Mousse when state switching is forbiddend.
	...
	if(cowKey != os->copyOnWriteOwner) {
		assert(0 && "Should not come to this point for distributed Mousse");
	}
        return 1;
    }
};
