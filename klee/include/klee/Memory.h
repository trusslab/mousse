...
public:
    ...
    void writeEvaluatedValue8(unsigned offset, uint8_t value);
    void writeEvaluatedValue32(unsigned offset, uint32_t value);
    void mark8(unsigned offset);
    ...
    inline bool isBufferConcrete(unsigned offset, unsigned size) const {
        if (!concreteMask)
            return true;
   ...
   void setConcreteStore(uint8_t *source_addr);
...
/* This is ugly */
uint64_t s2e_solve_suggestedValue_for_concolicVar(klee::ref<klee::Expr> value);
