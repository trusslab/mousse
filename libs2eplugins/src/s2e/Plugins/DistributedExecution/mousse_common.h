...
/*
#define END_REASON_UNKNOWN      0
#define END_REASON_TIMEOUT      1
#define END_REASON_SYSCALL      2
#define END_REASON_TEST_FINISH  3
#define END_REASON_EXIT         4
...
#define STATUS_TERM_MMAP        5 | STATUS_TERM
...
#define SYM_SYSCALL_HAS_FD  0x80000000
#define SYM_SYSCALL_PTR_ARG 0x40000000
