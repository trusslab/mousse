...
void init_s2e_libcpu_interface(struct se_libcpu_interface_t *sqi) {
    ...
    sqi->exec.update_klee_cpu = se_libcpu_update_klee_cpu;
    sqi->exec.do_interrupt_all = g_s2e_do_interrupt_all;
    sqi->exec.do_interrupt_arm = g_s2e_do_interrupt_arm;
    sqi->exec.get_brk_info = s2e_get_brk_info;
    sqi->exec.set_brk_info = s2e_set_brk_info;
    ...
    sqi->mem.write_evaluatedValue_to_symbolicRegion = s2e_write_evaluatedValue_to_symbolicRegion;
    sqi->mem.read_ram_concrete = s2e_read_ram_concrete;
    sqi->mem.write_ram_concrete = s2e_write_ram_concrete;
    sqi->mem.verify_write_ram_concrete = s2e_verify_write_ram_concrete;
    ...
    sqi->events.on_concretize_syscall_args = s2e_on_concretize_syscall_args;
    sqi->events.on_do_syscall_start = s2e_on_do_syscall_start;
    sqi->events.on_do_syscall_end = s2e_on_do_syscall_end;
    sqi->events.on_load_image_end = s2e_on_load_image_end;
    sqi->events.on_other_make_concolic = s2e_on_other_make_concolic;
    sqi->events.on_receive_signal = s2e_on_receive_signal;
    sqi->events.on_thread_create = s2e_on_thread_create;
    sqi->events.on_thread_exit = s2e_on_thread_exit;
