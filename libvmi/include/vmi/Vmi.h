...
public:
     ...
     */
    bool getOffset(const VmiStructureType *struc, const std::string &path, uintptr_t &offset) const;
    bool getOffset(const std::string &strucName, const std::string &path, uintptr_t &offset) const;
