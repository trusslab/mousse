...
extern se_libcpu_update_klee_cpu_t se_libcpu_update_klee_cpu;
...
void tcg_llvm_before_memory_access(target_ulong vaddr, target_ulong value, unsigned size, unsigned flags);

void tcg_llvm_after_memory_access(target_ulong vaddr, target_ulong value, unsigned size, unsigned flags, uintptr_t retaddr);
uint64_t tcg_llvm_trace_port_access(target_ulong port, target_ulong value, unsigned bits, int isWrite);
