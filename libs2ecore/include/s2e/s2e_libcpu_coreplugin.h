...
void s2e_on_do_syscall_start(uint64_t syscall_id, struct SyscallArguments *args);

void s2e_on_do_syscall_end(uint64_t syscall_id, uint64_t ret, struct SyscallArguments *args);

void s2e_on_load_image_end(struct ImageInfo *info);
