...
protected:
    ...
    void writeSymbolicRegionSilentInternal(klee::ObjectPair op, uint64_t object_offset, uint64_t size);
    ...
    void changeSymbolicRamInternal(klee::ObjectPair op, uint64_t object_offset, uint64_t size);
...
public:
    ...
    void writeSymbolicRegionSilent(struct CPUTLBRAMEntry *te, uint64_t hostAddress, uint64_t size); 
    ...
    void changeSymbolicRam(struct CPUTLBRAMEntry *te, uint64_t hostAddress, uint64_t size);
